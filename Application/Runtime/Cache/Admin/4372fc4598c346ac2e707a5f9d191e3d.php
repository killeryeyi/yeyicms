            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
						...
						<div class="col-lg-6">
                                    <form role="form" method="post" action="<?php echo U('group/edit_group');?>">
                                             ...
                                             <div class="controls">
													<ul style="border: 1px solid #e5e5e5;padding: 5px;margin-bottom: 10px;border-radius:5px">
														<div style="border-bottom: 1px dashed #e5e5e5;">
															<label><input type="checkbox" class="all" <?php if($c_all == true): ?>checked<?php endif; ?>/>全选</label>
														</div>
													</ul>
													<?php if(is_array($rule)): $i = 0; $__LIST__ = $rule;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul style="border: 1px solid #e5e5e5;padding: 5px;margin-bottom: 10px;border-radius:5px">
														<div style="border-bottom: 1px dashed #e5e5e5;">
															<label><input type="checkbox" name="mid[]" value="<?php echo ($vo["id"]); ?>" class="in st_<?php echo ($vo["id"]); ?>" <?php if(in_array($vo['id'],$mid)): ?>checked<?php endif; ?>/> <?php echo ($vo["title"]); ?></label>
														</div>

													<?php if(is_array($vo['last'])): $i = 0; $__LIST__ = $vo['last'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><span style="margin-left: 15px"><label><input type="checkbox" name="mid[]" value="<?php echo ($v["id"]); ?>" str="<?php echo ($v["pid"]); ?>" class="int str_<?php echo ($v["pid"]); ?>" <?php if(in_array($v['id'],$mid)): ?>checked<?php endif; ?>/> <?php echo ($v["title"]); ?></label></span><?php endforeach; endif; else: echo "" ;endif; ?>
