            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
						...
						<div class="col-lg-6">
                                    <form role="form" method="post" action="<?php echo U('Menu/m_edit');?>">
                                        ...
                                        <div class="form-group">
											...
											<input class="form-control" type="hidden" name="url1" value="<?php echo ($info["url"]); ?>">
											<p class="help-block">index/index</p>
                                        </div>
										<div class="form-group">
                                            <label>上级菜单</label>
                                            <select multiple="" class="form-control" name="pid">
											<option value="0"<?php if($info[pid] == 0): ?>selected<?php endif; ?>>顶级</option>
											<?php if(is_array($menu_list)): $i = 0; $__LIST__ = $menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($info[pid] == $vo[id]): ?>selected<?php endif; ?>><?php echo ($vo["title"]); ?></option>
												<?php if(is_array($vo['last'])): $i = 0; $__LIST__ = $vo['last'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($voo["id"]); ?>" <?php if($info[pid] == $voo[id]): ?>selected<?php endif; ?>>&nbsp;&nbsp;——<?php echo ($voo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="level">
                                                <option value="1" <?php if($info[level] == 1): ?>selected<?php endif; ?>>一级</option>
                                                <option value="2" <?php if($info[level] == 2): ?>selected<?php endif; ?>>二级</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>排序</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="status" id="optionsRadios1" value="0" <?php if($info[status] == 0): ?>checked="true"<?php endif; ?>>显示
                                                </label>
												<label>
                                                    <input type="radio" name="status" id="optionsRadios1" value="1" <?php if($info[status] == 1): ?>checked="true"<?php endif; ?>>隐藏
                                                </label>
                                            </div>
                                           
                                        </div>
                                       
                                        <input class="form-control" type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
