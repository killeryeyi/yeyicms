                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover"
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                    ...
                                    <td>
									<a href="<?php echo U('group/edit_group',array('id'=>$vo[id]));?>"><button type="button" class="btn btn-link">修改</button></a>
									<a href="<?php echo U('group/del_group',array('id'=>$vo[id]));?>"><button type="button" class="btn btn-link">删除</button></a>
									</td>
                                </tr>
