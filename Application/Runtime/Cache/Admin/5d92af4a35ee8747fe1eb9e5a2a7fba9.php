            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
						...
						<div class="col-lg-6">
                                    <form role="form" method="post" action="<?php echo U('user/ass_group');?>">
                                        <div class="form-group">
                                            <label>角色列表</label>
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="radio">
                                            <label class="checkbox-inline">
                                                <input name="gid[]" type="radio"  value="<?php echo ($vo["id"]); ?>"  <?php if(in_array($vo['id'],$gid)): ?>checked<?php endif; ?>><?php echo ($vo["name"]); ?></label>
                                            </label>
