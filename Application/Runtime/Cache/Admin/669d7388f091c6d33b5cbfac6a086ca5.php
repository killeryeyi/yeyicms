                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$datalist): $mod = ($i % 2 );++$i;?><tbody>
                                <td><?php echo ($datalist["basename"]); ?></td>
                                <td><?php echo (format_bytes($datalist["size"])); ?></td>
                                <td><?php echo (date('Y-m-d H:i:s',$datalist["create_time"])); ?></td>
                                <td>
                                    <a class="link-importsql edit" href="javascript:;"  onclick="importsql('<?php echo U('importsql');?>','<?php echo ($datalist["basename"]); ?>')">还原</a>
                                    <!-- <a class="link-downsql edit" href="/yeyicms/Uploads/data/<?php echo ($datalist["basename"]); ?>" download="<?php echo ($datalist["basename"]); ?>">下载</a>-->
                                    <a class="link-del edit" href="javascript:;" onclick="del('<?php echo U('del');?>','<?php echo ($datalist["basename"]); ?>')" >删除</a>
                                </td>
