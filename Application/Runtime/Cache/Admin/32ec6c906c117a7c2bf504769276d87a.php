...
<script type="text/javascript" src="/yeyicms/Public/login/js/jquery-1.9.0.min.js"></script>
<script type="text/javascript" src="/yeyicms/Public/login/images/login.js"></script>
<link href="/yeyicms/Public/login/css/login2.css" rel="stylesheet" type="text/css" />
</head>
<body>
<h1>后台管理</h1>
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
               ...
               <div class="inputOuter" id="pArea">
                ...
                <div style="padding-left:50px;margin-top:20px;"><input type="button" value="登 录" style="width:150px;" class="button_blue" id="login"/></div>
              </form>
           </div>
    ...
    $(function(){
        $("#login").click(function(){
            if($("#username").val()==""){
                ...
                $.post("/yeyicms/admin.php/login/login",{user:$("#username").val(),pass:$("#password").val()},function(data){
                    if(data.status==1){
                        window.location.href="/yeyicms/admin.php/index/index";
                    }else{
                        alert(data.info);
                    }
                },"json")
