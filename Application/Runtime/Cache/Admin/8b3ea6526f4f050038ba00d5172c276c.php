                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-6">
                                <form role="form" method="post" action="<?php echo U('site/add_banner');?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>上传图片</label>
                                        <input class="" name="photo" type="file" value="">
                                    </div>
                                    <div class="form-group">
                                        <label>标题</label>
                                        <input name="title" type="text" class="form-control" style="width:365px" value="<?php echo ($info["title"]); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>url</label>
                                        <input name="url" type="text" class="form-control" style="width:365px" value="<?php echo ($info["url"]); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>排序</label>
                                        <input class="form-control" name="sort" type="text" value="<?php echo ($info["sort"]); ?>">
                                    </div>
