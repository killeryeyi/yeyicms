...
-- / --
-- 主机: localhost --
-- 生成日期: 2017-09-23 13:35:11 --
-- 服务器版本: 5.6.17 --
-- PHP 版本: 5.5.12 --
-- --------------------------------------

-- 数据库：yeyicms --
CREATE DATABASE IF NOT EXISTS `yeyicms` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `yeyicms`;
-- end 数据库：yeyicms --

-- ----------------start table rt_admin----------------------
...
-- ----------------end table rt_admin_group----------------------

-- ----------------start table rt_admin_log----------------------
...
-- ----------------end table rt_admin_log----------------------

-- ----------------start table rt_admin_rule----------------------
...
-- ----------------end table rt_admin_rule----------------------

-- ----------------start table rt_article----------------------
...
-- ----------------end table rt_article----------------------

-- ----------------start table rt_banner----------------------
